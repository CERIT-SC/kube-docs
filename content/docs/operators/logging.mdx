...
Logging in the Kubernetes cluster is handled by a [Logging operator](https://kube-logging.dev/). This tool allows the creation of customized logging pipelines that meet user requirements.
