...
V tomto příkladu je vytvořena jednotlivá instance s vygenerovaným uživatelským jménem a heslem. Jetaké možné poskytnout vlastní objekt `Secret` místo automaticky vygenerovaného uživatelského jména/hesla.
