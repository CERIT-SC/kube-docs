...
<Callout type="info">
We are pleased to announce that *AlphaFold3* is now accessible for use. To access the software, you must first agree to the [Alphafold3 model terms of use](https://github.com/google-deepmind/alphafold3/blob/main/WEIGHTS_TERMS_OF_USE.md). 
Before using AlphaFold3, please request to be added to the appropriate group by confirming that you have read and agree to the [license agreement](https://signup.e-infra.cz/fed/registrar/?vo=meta&group=lic_alphafold3)
</Callout>
