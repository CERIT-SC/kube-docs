...
V tejto časti sa dajú pomenova+t kontajnere a tak vytvoriť. Do panelu home sa dá prejst vždy, čiže študent si môže vyrobiť kontajner pre predmet X, spustiť si ho a keď bude chcieť ďalší, môže prejsť buď do home alebo z notebooku cez `Hub Control Panel` do toho istého menu (obr v ďalšej sekcii).
