...
### Claude Code Integration in Jupyter Notebook

Some of our Jupyter notebooks (specifically those using the `cerit.io/hubs/datasciencenb:2026-01-23-ai` image) come pre-integrated with **Claude Code**.
...
Claude Code is not just a chatbot; it is an agentic coding assistant. Unlike standard auto-complete tools, Claude Code acts as a partner that understands the broader context of your project. It can read your notebook, analyze your data structures, and navigate your file system to assist with complex tasks—from data cleaning pipelines to visualization and debugging. This integration fully supports "Vibe Coding."
...
VScode with Claude Code support image: `cerit.io/hubs/minimalnb-cs:06-02-2026-ai`
