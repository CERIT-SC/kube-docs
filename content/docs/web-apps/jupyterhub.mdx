...
1. Go to [hub.cloud.e-infra.cz](https://hub.cloud.e-infra.cz).
2. Select the **RStudio-AI** image (*version 4.6.1 with Posit Assistant support*).
3. Configure your required server resources and click **Start**.

![RStudio launcher](/img/ceritsc/apps/jupyterhub/rstudio-click.png)

4. Once the environment finishes loading, RStudio will open automatically.

**Setting Up Posit Assistant**

1. In the top-right corner of the RStudio interface, click the **Posit Assistant** button.

![Posit Assistant location in RStudio](/img/ceritsc/apps/jupyterhub/rstudio.png)

2. Click **Install Posit Assistant**.

![Install Posit Assistant interface](/img/ceritsc/apps/jupyterhub/rstudio-positassistant1.png)

3. When prompted, select **Trust Workspace** to proceed.
...
4. Configure your preferred model:
   * Click the **three dots** icon (**`...`**) in the bottom-left corner of the Assistant panel.
...
![Accessing Posit Assistant model settings](/img/ceritsc/apps/jupyterhub/rstudio-positassistant3.png)
