...
<img src="/img/ceritsc/apps/jupyterhub/jupyter-intelligence.png" alt="Minimal NB with AI" width="800" />

![Minimal NB with AI](/img/ceritsc/apps/jupyterhub/jupyter-intelligence.png){ width="200" }
