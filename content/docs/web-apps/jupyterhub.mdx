...
2. Select Custom Image: cerit.io/hubs/datasciencenb:2026-01-23-ai
...
2. Select Custom Image: `cerit.io/hubs/rstudio:4.5.2-ai`
...
1. 1. Log in to your JupyterHub dashboard [hub.cloud.e-infra.cz](https://hub.cloud.e-infra.cz/), start a new server

2. Select Custom Image: cerit.io/hubs/minimalnb-cs:06-02-2026-ai
