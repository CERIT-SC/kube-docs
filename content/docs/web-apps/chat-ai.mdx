...
| **LLaMA 4 Scout**    | A 109B language model from Meta. Its efficiency and versatility make it well-suited for diverse natural language processing tasks. Features vision capabilities for image description generation. |
