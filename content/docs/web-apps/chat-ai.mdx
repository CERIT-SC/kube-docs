...
<center>
![chatscroll](/img/ceritsc/chat-ai-scroll.gif){width=400px}
</center>
...
|Gemma3        |Language model of Google, 27B FP16 variant, Gemma is a lightweight, family of models from Google built on Gemini technology.|
|Phi4          |Language model of Microsoft, 14B Q8 variant, state-of-the-art open model built upon a blend of synthetic datasets, data from filtered public domain websites, and acquired academic books and Q&A datasets.|
|QwQ           |Language model of Chinese Qwen, 32B FP16 variant, it is the medium-sized reasoning model, which is capable of achieving competitive performance against state-of-the-art reasoning models, e.g., DeepSeek-R1, o1-mini.|
