...
Following the steps below, you can run Scipion application. While installing the application you will be prompted to enter information to mount Onedata. This application has no persistent data, except mounted Onedata storages. It means, that if you delete the application and later install the application again, the data you saved outside the Onedata mounts will be lost. Behaviour behind the Onedata mounts is described bellow.
...
The first item to fill in the form is the `noVNC password`, which you will need to access remote desktop of the Scipion application. Onedata related items in the form are described below.
