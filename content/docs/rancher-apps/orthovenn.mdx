...
![orthovenn3](/img/ceritsc/apps/orthovenn/orhovenn3.png)
    
    - **login name and password**, which everyone who uses the app will share;

![orthovenn4](/img/ceritsc/apps/orthovenn/orhovenn4.png)
    
    - **data volume size** — how much room you want for genomes and results;

![orthovenn5](/img/ceritsc/apps/orthovenn/orhovenn5.png)
    
    - how much** CPU and memory** the analyses may use.

![orthovenn6](/img/ceritsc/apps/orthovenn/orhovenn6.png)
