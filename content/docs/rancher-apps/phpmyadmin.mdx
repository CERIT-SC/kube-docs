...
![selectapp](/img/ceritsc/apps/phpmyadmin/namespace.png)
...
You will open the login of the application, you will have to fill in your database login credentials, for purpose of this tutorial I'm logging in Moodle's MariaDB database.
