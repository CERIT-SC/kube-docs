...
## JupyterHub RStudio
JupyterHub je webová aplikace, která má jednoduchý vstupní formulář, kde si vybíráte různé nastavení nasazení. Chcete-li se dozvědět více, podívejte se na [úvod do JupyterHubu](../web-apps/jupyterhub), kde najdete další potřebné informace.
