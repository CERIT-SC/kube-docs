...
Pokud v kroku Instalace aplikace nevyberete možnost Upravit Helm možnosti před instalací, instalace se může zdát jako neúspěšná, ale ve skutečnosti po nějaké době proběhne úspěšně.
