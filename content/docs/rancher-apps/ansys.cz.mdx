...
Ve druhé části formuláře vyberete heslo. Toto heslo se používá pro přihlášení k VNC. Pokud není vybráno VNC, musíte také vyplnit `username`, tyto přihlašovací údaje budou použity v prohlížeči pro připojení k relaci *WEBRTC*.
