...
Podle níže uvedených kroků můžete spustit vlastní aplikaci Minio server. Tato aplikace slouží k vystavení nebo nahrávání dat do jiné běžící aplikace, která používá persistent volume claim. Přenos dat lze provádět prostřednictvím webového rozhraní -- pomocí pouze webového prohlížeče nebo prostřednictvím protokolu [S3](https://en.wikipedia.org/wiki/Amazon_S3) (ten nesouvisí s Amazon AWS, jedná se pouze o jejich protokol pro přístup k našim datům).
