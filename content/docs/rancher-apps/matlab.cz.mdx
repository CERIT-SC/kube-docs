...
Když kliknete na chart, můžete vybrat verzi aplikace, jak je znázorněno níže. Vyberte `Chart Version`, přesnou verzi Matlabu najdete pod `Application Version`. Verze se mohou v průběhu času lišit. Klikněte na `Nainstalovat`, abyste pokračovali.
