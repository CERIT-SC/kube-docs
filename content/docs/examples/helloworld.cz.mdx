...
Nakonec musíme vytvořit `Ingress`, který vystavuje HTTP a HTTPS cesty ze světa ven do světa clusteru. Provoz je řízen pravidly nastavenými v zdroji.
Je možné vystavit vaše nasazení [2 způsoby](../kubernetes/expose), ale zde použijeme cluster LoadBalancer s vytvořením pouze nového DNS názvu.
