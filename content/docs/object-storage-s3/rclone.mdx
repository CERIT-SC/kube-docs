...
## List of Contents
1. [Downloading and Installation](#downloading-and-installation-of-rclone-tool)
    * [on Linux](#linux---manual-installation-in-user-profile)
    * [on Windows](#windows---manual-installation-in-user-profile)
1. [Basic Configuration](#basic-rclone-configuration)
    * [using command line](#rclone-configuration-using-the-command-line)
    * [using graphical user interface](#rclone-configuration-using-graphical-user-interface)
    * [configuration file](#configuration-file)
1. [Basic Controls](#rclone-basic-controls)
1. [Configuration and Management of Encrypted Buckets](#configuration-and-management-of-encrypted-buckets)
    * [using command line](#configuration-using-the-command-line)
    * [using graphical user interface](#configuring-the-encrypted-bucket-using-the-graphical-user-interface)
    * [verifying the integrity of encrypted data](#verifying-the-integrity-of-encrypted-data)
    * [sharing encrypted buckets](#sharing-of-encrypted-buckets)
    * [compromised or lost encryption password ](#compromise-of-encryption-passwords-vs-loss-of-encryption-passwords)
1. [Mounting the remote as a filesystem or a drive](#mounting-the-remote-as-a-filesystem-or-a-drive)
    * [Mounting in Widnows](#mounting-in-windows)
...
In the next steps, enter your **access_key_id** and **secret_access_key**, which you either received from the administrator or generated yourself on the [Gatekeeper server](https://access.du.cesnet.cz/) .
...
Enter the **Option endpoint** corresponding to the data center for which you generated the credentials (**s3.cl2.du.cesnet.cz** as an example). Check the [Gatekeeper key generator page](https://access.du.cesnet.cz/) if you do not rememebr the endpoint address. 
