...
To create a bucket, use **[aws tool](./aws-cli)** or **[s3cmd](./s3cmd)**, or during storage configuration let us create the bucket(s) for you.
...
5. Fill in the repository **Name** and **Description**, then check **Limit concurrent tasks to** and set the value to **5** then Click **Next**.
...
<Callout type="warn" icon="⚠️">  
Storing an excessively large amount of data in a single bucket is not recommended. As a general guideline, around **100 TB** and **50 million objects** can be considered a reasonable maximum.<br/>
...
- Install and configure **[Veeam ONE Community Edition](https://www.veeam.com/products/free/monitoring-analytics.html)**
