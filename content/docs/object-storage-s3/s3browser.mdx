...
[S3 Browser](https://s3browser.com/) is a powerful and user-friendly freeware client for S3 storage on Windows. It allows you to manage up to two S3 accounts at no cost.
...
Open the S3 Browser tool and then click on **1. Tools** in the main menu, followed by **2. Options**.
