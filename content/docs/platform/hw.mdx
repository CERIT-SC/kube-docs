...
<table>
  ...
  <tbody>
    <tr>
      <td>CPU:</td><td>2x AMD EPYC 7543 32-Core Processor<br/>(in total 64CPU per node):<br/>2x AMD EPYC 9454 48-Core Processor<br/>(in total 96CPU per node):</td><td>All nodes apart from *kub-c*<br/><br/>8 HPC *kub-c* nodes</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      <td>CPU:</td><td>2x AMD EPYC 7543 32-Core Processor<br/>(in total 64CPU per node)</td><td></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      <td>CPU:</td><td>2x AMD EPYC 7543 32-Core Processor (in total 64CPU per node):<br/>2x AMD EPYC 9454 48-Core Processor (in total 96CPU per node):<br/>1x Intel(R) Xeon(R) CPU E5-2650 v4 @ 2.20GHz 24-Core Processor:<br/>2x AMD EPYC 9454 48-Core Processor (in total 96CPU per node):</td><td>kub-as1 -- kub-as6<br/>kub-cs1, kub-cs2<br/>kblack<br/>kub-ds1, kub-ds2, kub-ds3</td>
    </tr>
    <tr>
