...
It hosts open large language and generative models (e.g., DeepSeek R1, Qwen3-Coder-480B, Gemma3, and GPT-OSS-120B), accessible via an Open WebUI interface or OpenAI-compatible APIs.
