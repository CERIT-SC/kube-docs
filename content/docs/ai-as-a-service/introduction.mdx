...
| Service                   | Link                                                                 | Description                                                                                                                              |
|---------------------------|----------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| **Chat (Open-WebUI)**     | [WebUI chat](../ai-as-a-service/chat-ai)                             | A full-featured conversational interface (similar to ChatGPT) offering advanced features and explicit language model selection.           |
