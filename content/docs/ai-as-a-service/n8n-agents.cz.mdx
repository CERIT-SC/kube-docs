...
V n8n je AI agent vytvářen vizuálně. Uzel AI Agent se nachází uprostřed a funguje jako řídicí prvek. Můžete připojit „Mozek“ (LLM model), „Nástroje“ (Tools) a „Paměť“ (Memory) přímo ke vstupům uzlu agenta. Workflow obvykle začíná Triggerem, například Chat Triggerem nebo Webhookem.
