...
3. Add the API Key, for our models use the token generated above and `Base URL: https://llm.ai.e-infra.cz/v1` 

<div class="w-200">  
![image-api](/img/ceritsc/n8n-choose-LLM-3.png)  
</div> 

Choose model from the list (GPT-OSS-120b)

<div class="w-200">  
![image-api](/img/ceritsc/n8n-choose-LLM-4.png)  
</div> 

4. Add `Chat trigger` from the list
<div class="w-200">  
...
6. try to ask for a simple calculation in the chat
<div class="w-200">  
