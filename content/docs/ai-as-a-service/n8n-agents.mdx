...
**Window Buffer Memory**: Keeps a "sliding window" of the last K messages. 
* Best for: Keeping token costs low while maintaining immediate context.

**Simple Memory**: Stores the entire conversation history in execution RAM. 
* Best for: Short, complex sessions where every detail matters.
