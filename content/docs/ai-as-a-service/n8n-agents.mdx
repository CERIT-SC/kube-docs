...
<div class="w-110">  
![image-api](/img/ceritsc/chat-ai-api-settings.png)  
</div> 
...
<div class="w-110">  
![image-api](/img/ceritsc/n8n-agent-calculator.png)  
</div> 
...
Adding API Key, for our models, use the token generated above and `Base URL: https://llm.ai.e-infra.cz/v1` 
<div class="w-110">  
