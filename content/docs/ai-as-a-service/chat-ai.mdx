...
| Model         |      Model Name         |  Capability  | Description | Context Size |
|---------------|---------------|----------|-------------|--------------|
| **GLM 5.2 (max)**    | glm-5.2              |  `multimodal`, `coder`, `tool`    | The 1M-token context GLM 5.2 fp8 language model for advanced "agentic" reasoning and superior multi-step task handling | 1M |
...
| **Qwen 3.5**  | qwen3.5   |   `agentic`, `multimodal`, `coder`, `tool`   |  397B fp4 multimodal advanced model for coding, tool use, and agentic workflows | 262k   |
