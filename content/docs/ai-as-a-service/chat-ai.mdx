...
Please coordinate with us before running benchmarks.
...
- Skewed Results: Requests accumulate in a shared queue, meaning your performance metrics will reflect server wait times rather than actual model processing speed.
- Resource Strain: Heavy testing restricts vital resources for peers relying on these models for active research.
If you plan to perform benchmarking, please contact us in advance so we can help you get accurate data without disrupting the community.
</Callout>
