...
| **Qwen3.8 (27B, FP8)** | `qwen3.8-27b` | chat, multimodal, tools | 262k | 32k | fp8| [QuantTrio/Qwen3.8-27B-FP8](https://huggingface.co/Qwen/Qwen3.8-27B-FP8) |
...
- **Qwen3.8 (27B, FP8)** - 27B dense multimodal model for coding, research, professional tasks, and complex agentic workflows. Supports images and videos, with configurable thinking for balancing speed and reasoning.
...
**Note on legacy aliases:** Older aliases (e.g., `glm-5`, `kimi-k2.6`) currently resolve to their updated equivalents for backward compatibility, but will be deprecated soon. Please update your code to current aliases or exact names.
</Callout>
