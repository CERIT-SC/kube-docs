...
<Callout type="info">
User Responsibility: **Do not upload highly sensitive, classified, or PII (Personally Identifiable Information) files to the chat interface**. While our infrastructure is private, the platform is intended for general assistance and research; it is not currently certified for the processing of sensitive/protected documents.
</Callout>
