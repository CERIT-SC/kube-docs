...
| **Qwen3.5**     |  qwen3.5-122b,  |  `multimodal`, `ćoder`, `tool`    | A 122B language model from Qwen. Succeeds the Qwen3-coder with significantly enhanced performance in coding tasks. | 256k   |
...
| **Kimi K2.5**  | kimi-k2.5   |  `agentic`, `multimodal`, `ćoder`, `tool`       |  Large-scale MoE model with roughly 1 trillion parameters with significantly enhanced performance in coding tasks. | 256k   |
| **Qwen 3.5**  | qwen3.5   |   `multimodal`, `ćoder`, `tool`   |  397B Multimodal advanced model for coding, tool use, and agentic workflows | 262k   |
| **Mistral-small**  | mistral-small-4   |   `multimodal`, `ćoder`  |  397B Multimodal advanced model for coding, tool use, and agentic workflows | 262k   |
