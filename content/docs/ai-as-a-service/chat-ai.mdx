...
**Model Availability and Academic Works**

We do not guarantee that a specific model will remain available throughout the entire year. Especially during the semester, models may be updated to newer versions or replaced entirely by superior alternatives. 

If you are working on a bachelor's or master's thesis, it is highly recommended in your own interest to test your solution across multiple models simultaneously. Aim to design your work, scripts, and methodologies to be flexible and independent of any single, specific model.
