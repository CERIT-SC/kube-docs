...
<Callout type="warn">
Chat.ai does not have the enhanced security measures required to process sensitive data. **Do not upload highly sensitive, classified, or PII (Personally Identifiable Information) files to the chat interface**. While our infrastructure is private, the chat platform is designed for general assistance and research; it is not currently certified for the processing of sensitive/protected documents.
</Callout>
