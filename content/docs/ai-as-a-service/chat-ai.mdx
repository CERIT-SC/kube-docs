...
**Added:** New models are integrated based on a rigorous evaluation process. This includes analyzing performance across industry-standard benchmarks, assessing specific community feedback, and monitoring the evolving landscape of open-source AI.
...
However, we still want to remove deprecated models as soon as possible, due to having limited GPU allocations specialized for deployed LLMs, and these GPUs should be diverted to more recent and better-performing models for the benefit of the whole NRP community. 
...
All administrators have signed NDAs.
