...
| **DeepSeek V3.2**    |  deepseek-v3.2-thinking  | `coder`, `reasoning` | A 685B reasoning and instruct (selectable) language model from DeepSeek AI. Excels at complex tasks, including mathematics, logical reasoning, and code generation. | 160k |
...
<Callout type="info">
Although **DeepSeek V3.2** and **Qwen3.5** are designated as **guaranteed** models, please note:
...
| **Mistral-small**  | mistral-small-4   |   `multimodal`, `coder`  |  397B Multimodal advanced model for coding, tool use, and agentic workflows | 262k   |
