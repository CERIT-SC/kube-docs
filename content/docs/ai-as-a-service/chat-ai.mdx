...
| Model         |      Model Name         |  Capability  | Description | Context Size |
|---------------|---------------|----------|-------------|--------------|
| **GLM 5**    | glm-5              |  `multimodal`, `tool`    | The 744B GLM 5 fp4 language model for advanced "agentic" reasoning and superior multi-step task handling | 200k |
...
| **Qwen 3.5**  | qwen3.5   |   `multimodal`, `coder`, `tool`   |  397B Multimodal advanced model for coding, tool use, and agentic workflows | 262k   |
