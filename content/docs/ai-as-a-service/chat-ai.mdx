...
| **Qwen3.5**     |  qwen3.5-122b,  |  `multimodal`, `tool`    | A 122B language model from Qwen. Succeeds the Qwen3-coder with significantly enhanced performance in coding tasks. | 256k   |
...
| **Qwen 3.5**  | qwen3.5   |   `multimodal`, `tool`   |  397B Multimodal advanced model for coding, tool use, and agentic workflows | 262k   |
| **Mistral-small**  | mistral-small-4   |   `multimodal`   |  397B Multimodal advanced model for coding, tool use, and agentic workflows | 262k   |
