...
| Model         |      Model Name         |  Capability  | Description | Context Size |
|---------------|---------------|----------|-------------|--------------|
| **GLM 5.2 (max)**    | glm-5.2              |  `multimodal`, `coder`, `tool`    | The 753B GLM 5.2 fp4 language model for advanced "agentic" reasoning and superior multi-step task handling | 300k |
