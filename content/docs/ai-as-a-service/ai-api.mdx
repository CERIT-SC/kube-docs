---
title: OpenAI API
description: Comprehensive guide for integrating with OpenAI-compatible API endpoints on the e-INFRA CZ AI platform
---
...
[Currently available models](/docs/ai-as-a-service/chat-ai#currently-available-models-as-of-january-26-2026)
