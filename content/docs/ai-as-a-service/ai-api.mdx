...
7. The base endpoint for the Open-WebUI API is: [https://llm.ai.e-infra.cz/v1/](https://llm.ai.e-infra.cz/v1/). This endpoint follows the OpenAI API specification, enabling compatibility with many existing LLM frameworks and applications.
