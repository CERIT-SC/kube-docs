...
<Callout type="info">
Workflow objects must be created in the **same namespace** where the Argo controller is running. It also means that `ClusterWorkflow` resources are not supported. 
