...
This command downloads the latest release. You can find all releases on the [CERIT-SC nextflow-go GitHub](https://github.com/CERIT-SC/nextflow-go/releases) page.
