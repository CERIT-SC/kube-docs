...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>GPU:</td><td>None:<br/><br/>2x NVIDIA A40 per node:<br/>1x NVIDIA A40 per node:<br/> 2x NVIDIA A10 per node:<br/>2x NVIDIA A100 (80GB) per node:<br/>1x NVIDIA H100 (PCIE/80GB):<br/>1x NVIDIA L4:<br/>1x NVIDIA H100 NVL (PCIE/94GB) per node:</td>
