...
<table>
  ...
  <tbody>
    <tr>
      <td>CPU:</td><td>2x AMD EPYC 7543 32-Core Processor<br/>(in total 64CPU per node):<br/>2x AMD EPYC 9454 48-Core Processor<br/>(in total 96CPU per node):</td><td>All nodes apart from *kub-c*<br/>8 HPC *kub-c* nodes</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>GPU:</td><td>None:<br/>2x NVIDIA A40 per node:<br/>1x NVIDIA A40 per node:<br/> 2x NVIDIA A10 per node:<br/>2x NVIDIA A100 (80GB) per node:<br/>1x NVIDIA H100 (PCIE/80GB):<br/>1x NVIDIA L4:<br/>1x NVIDIA H100 NVL (PCIE/94GB) per node:</td>
                   <td>kub-a5 -- kub-a9, kub-b3, kub-b9, kub-b14, kub-b15, kub-b17<br/>kub-a10 -- kub-a14, kub-b12<br/>kub-a15 -- kub-a20, kub-a22 -- kub-a24<br/>kub-b1 -- kub-b2, kub-b16<br/>kub-b4 -- kub-b8<br/>kub-b10 -- kub-b11<br/>kub-b13<br/>8 HPC *kub-c* nodes</td>
    </tr>
    <tr>
