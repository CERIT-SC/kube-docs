...
In general, this platform can be used for almost anything, starting with a simple web application, see the [hello world](../examples/helloworld) example, to running a full remote desktop, see the [ansys](../rancher-apps/ansys) application, or running a complex workflow pipeline, see the [nextflow](../workflows/nextflow) example.
