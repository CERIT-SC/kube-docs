...
>  - is still less than 0.1 for CPU (0.005 for GPU), counter is increased by one. If counter reaches `threshold+1` (e.g. for CPU, 8 as 7 days have already passed), instance is deleted.
