...
<Callout type="info">
We are pleased to announce that *AlphaFold3* is now accessible for use. Please note that in order to utilize this software, you must first agree to its license terms. 
Before accessing AlphaFold3, you are required to review and accept the [license agreement](https://signup.e-infra.cz/fed/registrar/?vo=meta&group=lic_alphafold3)
</Callout>
