...
Foldify is a web application based on [Alphafold](https://deepmind.google/technologies/alphafold/) tools available at [https://foldify.cloud.e-infra.cz](https://foldify.cloud.e-infra.cz), after login via e-INFRA CZ AAI.
...
![result](/img/ceritsc/apps/foldify/result.png)
