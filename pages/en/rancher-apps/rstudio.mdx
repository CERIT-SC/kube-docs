...
## Option 1: Running RStudio via JupyterHub (Recommended)
  ...
  *  Integration: This method provides seamless integration with MetaCentrum home, making it convenient for users already working within this ecosystem.

  * Supported Version: Currently, only R 4.2.1 is supported through this option.
This is our preferred method due to its simplicity and straightforward setup. 
To learn more, see [JupyterHub introduction](../webapps/jupyterhub) where you can find other necessary information.


## Option 2: Running RStudio as a Rancher Application

  *  Flexibility in R Versions: This approach allows you to choose from multiple R versions, providing greater flexibility depending on your project requirements.
...
Setup Complexity: This method is more involved and requires a more complex setup compared to the JupyterHub option.
