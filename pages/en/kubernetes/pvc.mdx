...
In case, you do not know CIFS password for CERIT-SC storage, just ask for one on support@cerit-sc.cz. It is **not** the same password you use for logging into infrastructure!
...
to your needs. You can request it at k8s@cerit-sc.cz.
