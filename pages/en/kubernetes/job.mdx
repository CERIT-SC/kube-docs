...
Jobs in the cluster do not have any special configuration apart from necessary secucity context. We provide sample configuration for you convenience.

If you are starting from this example, don't forget to change the following according to your needs:
...
- Container image
 ...
 - If you don't have a pre-prepared image, you can create your own according to our [documentation](https://docs.cerit.io/en/docker/dockerfile) which lists tips on how to create functional image
 - If you are unsure about the container image creation, [contact us](https://docs.cerit.io/en/platform/contacts) with questions
- User
...
- Resource requests
 ...
 - Optionally, you can request a GPU according to [GPU documentation section](https://docs.cerit.io/en/kubernetes/resources#gpu)
...
## A Word On Labels
Label fields (`metadata.labels`, nor `spec.template.metadata.labels`) are not required but we recommend to use them for better organization of objects. 
