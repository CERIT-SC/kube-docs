...
Kubernetes může vydávat a spravovat vlastní důvěryhodné certifikáty pomocí protokolu ACME. Certifikáty jsou uloženy jako objekty Secret.
...
Konfigurace generuje objekty Secret, specifikované v `spec.secretName`, obsahující certifikát a pár soukromého klíče.
